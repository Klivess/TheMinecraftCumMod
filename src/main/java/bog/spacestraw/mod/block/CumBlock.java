...
public class CumBlock extends LeEpicModModElements.ModElement {
	@ObjectHolder("le_epic_mod:cum")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("le_epic_mod:cum_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public CumBlock(LeEpicModModElements instance) {
		super(instance, 3);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("le_epic_mod:blocks/cum_still"), new ResourceLocation("le_epic_mod:blocks/cum_still"))
