...
package bog.spacestraw.mod.particle;
...
public class CumParticlesParticle extends LeEpicModModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public CumParticlesParticle(LeEpicModModElements instance) {
		super(instance, 15);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("cum_particles"));
	}
